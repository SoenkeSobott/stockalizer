...
def stream_news():
    ...
    while time_interval > 1512086400000000000:
        ticker = 'nflx'
        reuters_api_ticker = 'NFLX.OQ'
        try:
            response = urlopen(
                'https://wireapi.reuters.com/v8/feed/rcom/us/marketnews/ric:{0}?until={1}'.format(reuters_api_ticker, str(
            ...
            for item in response_json['wireitems']:
                ...
                with open('../../data/files/{0}_news.csv'.format(ticker), 'a', newline='') as file:
