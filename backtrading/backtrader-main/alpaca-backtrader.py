...
class SentimentStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        # self.tweet_sentiment = self.datas[2].sentiment_score
    ...
    def next(self):
        ...
        if self.order:
            return
        self.news_sentiment = self.datas[1].sentiment_score
    ...
    def stop(self):
        ...
        # Helpser Class for adding a CSV with sentiment scores
...
if __name__ == '__main__':
    ...
    if is_backtesting:
        ...
        news_sentiment_data = "../../data/files/AMZN/amzn_news_with_scores.csv"
        data1 = SentimentCSV(
